...
<body>
	...
	<div>
	 	...
	 	사번 : <input type="text" id="empNoSearch">
		상태
	...
	<div>
	   <h2>휴가 신청</h2>
	      사번 <input type="text" class="empNo">
	...
	<script>
		...
		$.ajax({
			...
			success : function(result1) {
				...
				for(const leaveDays of result1) {
					var text = "<b>사번</b> : " + leaveDays.empNo
						       + "   <b>사원명</b> : " + leaveDays.empName
						       + "   <b>부서</b> :" + leaveDays.deptName 
							   + "   <b>직급</b> : " + leaveDays.jobTitle 
				...
				$("#result1").append(text);
   		      ...
   		      $.ajax({
   					...
   					success : function(result1) {
   						  ...
   						  for(const leaveTotalDays of result1) {
				...
				$.ajax({
					...
					success : function(result2) {
						$("#result2").empty();
						$("#result2").append("<tr><th>신청번호</th><th>신청날짜</th><th>유형</th><th>시작일</th><th>종료일</th><th>이유</th><th>상태</th><th>사원명</th><th>부서</th><th>직급</th><th>수정</th><th>삭제</th></tr>");
						for(const leaveInfo of result2) {
