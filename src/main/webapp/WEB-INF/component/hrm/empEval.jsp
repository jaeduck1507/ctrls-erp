	...
	<div id="filter-bar">
		...
		<select id="emp">
			...
			<c:forEach items="${empInfo}" var="emp">
				<option value="${emp.empNo}">${emp.empName}/
					${emp.jobTitle} / ${emp.deptName}</option>
			</c:forEach>
		</select>
		...
		<fieldset>
			...
			<label><input type="radio" name="attitudeScore" value="5"
				checked="checked">5점</label>
		</fieldset>
		...
		<fieldset>
			...
			<label><input type="radio" name="achieveScore" value="5"
				checked="checked">5점</label>
		</fieldset>
		<div>
