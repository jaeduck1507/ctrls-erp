        ...
        <nav>
	        <sec:authorize access="hasAnyRole('HRM','ADMIN','MANAGEMENT')">
	          <div class="menu-group">
	            ...
	            <div class="submenu">
	              <a href="/hrm/empInfo">사원정보조회</a>
	              <a href="/hrm/empAdd">사원정보추가</a>
	              <a href="/hrm/quitShow">퇴사자정보조회</a>
	              <a href="/hrm/empEval">인사/성과평가</a>
	            </div>
	          </div>
	        </sec:authorize>
		 	...
		 	<sec:authorize access="hasAnyRole('HRM','ADMIN','MANAGEMENT')">
			  <div class="menu-group">
	              ...
	              <div class="submenu">
	  			    <a href="/hrm/attendanceRecord">출근/퇴근 기록</a>
				    ...
				    <a href="/hrm/leaveAdd">휴가 신청</a>
				  	...
				  	<a href="/hrm/leaveDays">휴가 누적 사용일, 남은 휴가일 조회</a>
