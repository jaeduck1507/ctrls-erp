...
public interface ProductMapper {
    ...
    List<ProductDetailDTO> showProductDetail(Paging paging);
    ...
    List<ProductDetailDTO> searchProductDetail(Paging paging, String productName, String productCategory);
    
    void productBatchRegister(List<Product> productList);
    
    Integer totalProduct(); // product.jsp의 total, paging용
    
    Integer totalSearchProduct(String productName, String productCategory); // product.jsp의 search paging용
}
